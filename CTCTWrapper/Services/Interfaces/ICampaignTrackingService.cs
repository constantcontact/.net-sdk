...
namespace CTCT.Services
{
    ...
    public interface ICampaignTrackingService
    {
        ...
        ResultSet<BounceActivity> GetBounces(string accessToken, string apiKey, string campaignId, int? limit);
        ...
        ResultSet<ClickActivity> GetClicks(string accessToken, string apiKey, string campaignId, string linkId, int? limit);
        ...
        ResultSet<ForwardActivity> GetForwards(string accessToken, string apiKey, string campaignId, int? limit);
        ...
        ResultSet<OpenActivity> GetOpens(string accessToken, string apiKey, string campaignId, int? limit);
        ...
        ResultSet<SendActivity> GetSends(string accessToken, string apiKey, string campaignId, int? limit);
        ...
        ResultSet<OptOutActivity> GetOptOuts(string accessToken, string apiKey, string campaignId, int? limit);
