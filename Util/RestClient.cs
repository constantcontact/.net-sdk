...
namespace CTCT.Util
{
    ...
    public class RestClient : IRestClient
    {
        ...
        {
            return this.HttpRequest(url, WebRequestMethods.Http.Get, accessToken, null);
        }
        ...
        {
            return this.HttpRequest(url, WebRequestMethods.Http.Post, accessToken, data);
        }
        ...
        {
            return this.HttpRequest(url, WebRequestMethods.Http.Put, accessToken, data);
        }
        ...
        {
            return this.HttpRequest(url, "DELETE", accessToken, null);
        }

        private CUrlResponse HttpRequest(string url, string method, string accessToken, string data)
        {
